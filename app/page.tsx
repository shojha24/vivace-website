    ...
    <main>
      ...
      <div className="flex flex-col items-center justify-start min-h-screen h-128 py-2 bg-no-repeat bg-cover bg-bottom bg-[url('assets/landingpage_background.svg')]">
        ...
        <h1 className="max-sm:text-md max-md:text-lg md:text-xl font-bold mt-5 text-rose-500 text-center md:mx-48 max-md:mx-20 z-10">
          VIVACE is a high-school music group based in Lincroft, NJ. We make lives better through music.
        </h1>
      </div>
      ...
      <div className="bg-[#a51537] min-h-fit">
        <div className="grid mx-10 gap-8 grid-cols-3 grid-rows-3 max-md:grid-rows-6">
          ...
          <div className="md:col-span-1 max-md:col-span-3 row-span-1 bg-[url('assets/guitar.svg')] bg-contain max-md:bg-cover bg-center rounded-xl shadow-lg shadow-rose-800 transition ease-in-out delay-100 hover:scale-105 duration-300">
          </div>
          ...
          <div className="md:col-span-1 max-md:col-span-3 row-span-1 bg-[url('assets/piano.svg')] bg-contain max-md:bg-cover bg-center rounded-xl shadow-lg shadow-rose-800 transition ease-in-out delay-100 hover:scale-105 duration-300">
          </div>
